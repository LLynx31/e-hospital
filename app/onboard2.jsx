...
export default function Index() {
  ...
  return (
    <SafeAreaProvider>
      <View style={{paddingTop:inset.top}} className="flex flex-col h-screen w-screen  bg-blue-100">
        <View  className="w-full h-1/2 flex items-center ">
          <ImageBackground className="w-full h-full" source={require('@/assets/images/onboard2.png')}></ImageBackground>
        </View>
            ...
            <Link replace href={"/onboard3"} asChild>
              <Pressable>
                <View className="rounded-md px-5 w-[300px] text-white mt-5 bg-blue-600 py-2">
                 <Text className="text-base text-center text-white">suivant</Text>
                </View>
              </Pressable>
            </Link>
          </View>
